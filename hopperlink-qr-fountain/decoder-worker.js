import {parsePacket} from './protocol.js?v=qf06';
let reader=null;
...
async function scan(mod,image,{max=2,hard=false,denoise=false,errors=false}={}){return mod.readBarcodes(image,{formats:['QRCode'],maxNumberOfSymbols:max,tryHarder:hard,tryRotate:true,tryInvert:hard,tryDownscale:false,tryDenoise:denoise,binarizer:'LocalAverage',returnErrors:errors,textMode:'Plain'});}
