...
assert.strictEqual(I.VERSION,'1.2.0');
...
assert.strictEqual(manifest.build,'1200');
...
assert(sw.includes('hopperlink-one-v1200'));
console.log('HopperLink ONE Color Modes 2/3/4-bit: PASS');
